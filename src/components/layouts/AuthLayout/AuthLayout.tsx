  ...
  return (
    <div className='shadow-2xl rounded-2xl'>
      ...
      <div className='relative flex justify-center items-center lg:flex-row flex-col-reverse'>
        ...
        <div className='lg:w-[55%] w-full lg:min-h-full lg:px-0  md:px-5 px-3 lg:relative absolute lg:top-0 md:top-[23rem] top-[21rem]'>
          <div className='flex w-full justify-center items-center flex-col lg:min-h-screen min-h-[500px] bg-tfn-powder shadow-xl lg:rounded-l-3xl lg:rounded-r-none rounded-3xl'>{children}</div>
        </div>
