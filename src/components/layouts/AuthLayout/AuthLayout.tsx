...
const AuthLayout = ({ children }: AuthLayoutProps): JSX.Element => {
  return (
    <div className='shadow-2xl rounded-2xl lg:p-4 p-0 bg-[#f9f9f9]'>
      <div className='relative flex justify-center items-center lg:flex-row flex-col-reverse'>
        ...
        <div className='lg:w-[55%] w-full lg:h-screen lg:px-0 px-5 lg:relative absolute lg:top-0 md:top-[23rem] top-[21rem] '>
        ...
        <div className='lg:w-[45%] w-full lg:h-screen flex lg:py-0 md:py-28 py-24 justify-center items-center flex-col bg-tfn-group bg-no-repeat bg-cover bg-center lg:rounded-r-3xl lg:rounded-l-none rounded-b-3xl'>
