  ...
  return (
    <div className='relative flex justify-center items-center lg:flex-row flex-col-reverse'>
      <div className='absolute lg:top-6 md:top-4 top-2 lg:left-6 md:left-4 left-2 z-20'>
        <Image src={tfnLogo.src} className='md:h-12' width={200} height={100} alt='tfn logo' />
      </div>
      <div className='lg:w-[55%] w-full lg:h-screen lg:px-0 px-5 lg:relative absolute lg:top-0 top-[21rem]'>
