  ...
  return (
    <div>
      <div className='text-center'>
        ...
        <p className='text-[#989797] text-base leading-5 mt-4'>We sent an email to <b className='text-[#121212]'>tadealumni@gmail.com</b></p>
        ...
        <p className='sm:hidden'>Didn't recieve the mail? <a href="/" className='font-bold'>Click here to proceed</a></p>
        <p className='mt-5'><a href="/"><FontAwesomeIcon icon={faArrowLeft} className='mr-6 font-thin'/><b>Back to sign in</b></a></p>
        </div>
      </div>
      <div>
