    ...
    <>
      <form>
        ...
        <InputField
          ...
          className='bg-[#F5F6FA] border-b-2 border-b-[#989797] rounded-none shadow-none' placeholder='&#x25CF;&#x25CF;&#x25CF;&#x25CF;&#x25CF;&#x25CF;&#x25CF;&#x25CF;'/>     
        <div className=" mt-2 flex flex-row gap-x-4">
        
          <div
            className={`h-1 rounded-3xl w-[25%] transition duration-300 ease-in-out ${strength1 ? 'bg-tfn-green' : 'bg-[#989797]'}`}
          ></div>
        
          <div
            className={`h-1 rounded-3xl w-[25%] transition duration-300 ease-in-out ${strength2 ? 'bg-tfn-green' : 'bg-[#989797]'}`}
          ></div>
        
          <div
            className={`h-1 rounded-3xl w-[25%] transition duration-300 ease-in-out ${strength3 ? 'bg-tfn-green' : 'bg-[#989797]'}`}
          ></div>
        
          <div
            className={`h-1 rounded-3xl w-[25%] transition duration-300 ease-in-out ${strength4 ? 'bg-tfn-green' : 'bg-[#989797]'}`}
          ></div>
      ...
      <div className='my-6'>
        ...
        <div className='flex flex-col gap-y-3'>
          ...
          <label htmlFor="password" className='text-[#989797]'>Confirm password</label>
